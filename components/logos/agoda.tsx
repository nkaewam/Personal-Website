...
const Agoda: SVGHoverableLogoElement = ({
  fill = "#606055",
  className: c,
  ...
  <svg
    ...
    enableBackground="new 0 0 74.1 30.1"
    xmlSpace="preserve"
  ...
  >
    ...
    <path
      fill={fill}
      className={cn(
        showOriginalOnHover && "group-hover:fill-[#F59E22]",
        "transition-all duration-150"
      )}
    ...
    <path
      fill={fill}
      className={cn(
        showOriginalOnHover && "group-hover:fill-[#16AC5B]",
        "transition-all duration-150"
      )}
    ...
    <path
      fill={fill}
      className={cn(
        showOriginalOnHover && "group-hover:fill-[#8252A1]",
        "transition-all duration-150"
      )}
    ...
    <path
      fill={fill}
      className={cn(
        showOriginalOnHover && "group-hover:fill-[#347FC2]",
        "transition-all duration-150"
      )}
